...
export default class RecipesByChef extends Component {
  ...
  componentDidMount() {
       ...
       return fetch(ConfigApp.URL+'json/data_recipes_chef.php?chef='+this.props.route.params.IdChef)
...
<Ionicons name="md-arrow-back" style={{fontSize: 27, color: '#000'}}/>
    ...
    <Text style={{fontSize: 16, color: '#000', fontWeight: 'bold' }}>{this.props.route.params.TitleChef}</Text>
    </Col>
